...
@section('content')
    ...
    <div style="height: 150vh">
        ...
        <div class="row justify-content-between">
            <div class="col-md-2 p-4" style="height:10rem;" data-aos="fade-left">
            ...
            <div class="col-md-2 p-4" style="height:10rem;" data-aos="fade-left" data-aos-delay="300">
                <div class="text-center"><i class="fas fa-money-bill-wave-alt text-info" style="font-size:100px; "></i>
                </div>
                <div>
            ...
            <div class="col-md-2 p-4" style="height:10rem;" data-aos="fade-left" data-aos="fade-left" data-aos-delay="600">
            ...
            <div class="col-md-2 p-4" style="height:10rem;" data-aos="fade-left" data-aos-delay="900">
        ...
        <div class="row justify-content-center mt-lg-4" style="position: relative;top:350px">
            <div class="col-md-12">
                ...
                <ul class="stepper stepper-horizontal">
                        ...
                        <a href="#!">
                            <div class="row">
                                <span class="circle bg-dark" style="width: 60px;height:60px;font-size:40px"><span
                                        style="position: relative;top:15px">1</span></span>
                    ...
                    <li class="dark">
                        <a href="#!">
                            <div class="row">
                                <span class="circle bg-dark" style="width: 60px;height:60px;font-size:40px"><span
                                        style="position: relative;top:15px">2</span></span>
                            </div>
                    ...
                    <li class="dark">
                        <a href="#!">
                            <div class="row">
                                <span class="circle bg-dark" style="width: 60px;height:60px;font-size:40px"><span
                                        style="position: relative;top:15px">3</span></span>
                    ...
                    <li class="dark">
                        <a href="#!">
                            <div class="row">
                                <span class="circle bg-dark" style="width: 60px;height:60px;font-size:40px"><span
                                        style="position: relative;top:15px">4</span></span>
